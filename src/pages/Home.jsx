...
const Home = () => {
  return (
    <section>
      <div
        className="h-screen w-full lg:bg-cover bg-cover lg:bg-center lg:no-repeat overflow-auto"
        style={{
        ...
        <div className="h-screen flex flex-col gap-10 justify-center items-center text-center px-4">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[#BA986B] text-lg">
              Empowering communities by providing affordable legal support and
              human rights education...
            </p>
          </div>
          <div>
            <Link
              className="text-white bg-[#BA986B] hover:bg-[#a57e54] px-6 py-3 rounded-md transition-colors duration-500"
              to="/consultation">
              Book Consultation
            </Link>
          </div>
